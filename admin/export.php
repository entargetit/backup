...
{  
 ...
 $query = "Insert Into lead(name,email,phone,address,cat,empid,empName,empEmail,remark,calling_date,com_name,state) values ('$name','$email','$phone','$position','White','".$_SESSION['empid']."','".$_SESSION['empname']."','".$_SESSION['usssre']."','$remark','".date($format = 'Y-m-d', PHPExcel_Shared_Date::ExcelToPHP($calling_date))."','$company','$state')";  
